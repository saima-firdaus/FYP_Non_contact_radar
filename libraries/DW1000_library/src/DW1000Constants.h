...
// CIR Accumulator Constants 
#define ACC_MEM                     0x25
#define ACC_MEM_MAX_LEN             4064   // Total register bytes
#define ACC_MEM_N_SAMPLES_PRF64     1016   // Complex samples at PRF 64 MHz
#define ACC_MEM_N_SAMPLES_PRF16     992    // Complex samples at PRF 16 MHz
#define ACC_MEM_N_SAMPLES           1016   // Use this for PRF 64 MHz (safe upper bound)
#define ACC_MEM_BYTES_PER_SAMPLE    4      // 2 bytes I + 2 bytes Q
#define ACC_MEM_DUMMY_BYTE          1      // DW1000 inserts 1 dummy byte on every ACC_MEM read
